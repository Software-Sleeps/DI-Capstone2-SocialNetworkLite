...
function AlternateGetPosts(userToken = JSON.parse(sessionStorage.getItem("token"))) {
    ...
    // const getPosts = (userToken = JSON.parse(sessionStorage.getItem("token"))) =>{
    useEffect(() => {
    ...
    export default AlternateGetPosts;